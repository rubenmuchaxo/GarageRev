    ...
    public class ApplicationDbContext : IdentityDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Carros>().HasData(
                ...
                new Carros { Id = 10, Marca = "BMW", Modelo = "F44 serie 2 Gran Coupe", Versao = "218i", Combustivel = "Petrol", Ano = 2021, CilindradaouCapacidadeBateria = 1499, Potencia = 136, TipoCaixa = "6 speed Manual", Nportas = "4", Foto = "bmw_F44 Serie 2 gran Coupe_218i.jpg" },
