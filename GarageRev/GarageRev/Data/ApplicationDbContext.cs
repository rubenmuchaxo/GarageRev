    ...
    public class ApplicationDbContext : IdentityDbContext<IdentityUser> {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder) {
            ...
            modelBuilder.Entity<Carros>().HasData(
                ...
                new Carros { Id = 5, Marca = "BMW", Modelo = "F40 serie 1", Versao = "116i", Combustivel = "Petrol", Ano = 2020, CilindradaouCapacidadeBateria = 1499, Potencia = 109, TipoCaixa = "6 speed Manual", Nportas = "5", Foto = "bmw_F40_Serie1_116i.jpg" },
                new Carros { Id = 6, Marca = "BMW", Modelo = "F40 serie 1", Versao = "118i Auto", Combustivel = "Petrol", Ano = 2021, CilindradaouCapacidadeBateria = 1499, Potencia = 136, TipoCaixa = "7 speed DualClutch Automatic", Nportas = "5", Foto = "bmw_F40_Serie1_118i.jpg" },
                new Carros { Id = 7, Marca = "BMW", Modelo = "F40 serie 1", Versao = "128ti", Combustivel = "Petrol", Ano = 2020, CilindradaouCapacidadeBateria = 1998, Potencia = 265, TipoCaixa = "7 speed DualClutch Automatic", Nportas = "5", Foto = "bmw_F40_Serie1_128i.jpg" },
                new Carros { Id = 8, Marca = "BMW", Modelo = "F40 serie 1", Versao = "M135i xDrive", Combustivel = "Petrol", Ano = 2019, CilindradaouCapacidadeBateria = 1998, Potencia = 306, TipoCaixa = "8 speed Automatic", Nportas = "5", Foto = "bmw_F40_Serie1_m135i.jpg" },
                new Carros { Id = 9, Marca = "BMW", Modelo = "G02 X4 LCI", Versao = "xDrive30i", Combustivel = "Petrol", Ano = 2021, CilindradaouCapacidadeBateria = 1998, Potencia = 245, TipoCaixa = "8 speed Automatic", Nportas = "5", Foto = "bmw_G02_X4_LCI.jpg" },
                new Carros { Id = 10, Marca = "BMW", Modelo = "F44 serie 2 Gran Coupe", Versao = "218i", Combustivel = "Petrol", Ano = 2021, CilindradaouCapacidadeBateria = 1499, Potencia = 136, TipoCaixa = "6 speed Manual", Nportas = "4", Foto = "bmw_f44_Serie2_gran_Coupe_218i.jpg" },
                new Carros { Id = 11, Marca = "BMW", Modelo = "G21 serie 3 Touring", Versao = "318i Auto", Combustivel = "Petrol", Ano = 2020, CilindradaouCapacidadeBateria = 1998, Potencia = 156, TipoCaixa = "8 speed Automatic", Nportas = "5", Foto = "bmw_g21_serie3_touring_318i_auto.jpg" },
                new Carros { Id = 12, Marca = "BMW", Modelo = "G23 serie 4 Cabrio", Versao = "430i", Combustivel = "Petrol", Ano = 2021, CilindradaouCapacidadeBateria = 1998, Potencia = 258, TipoCaixa = "8 speed Automatic", Nportas = "2", Foto = "bmw_g23_serie4_cabrio.jpg" },
                ...
                new Carros { Id = 17, Marca = "Nissan", Modelo = "Micra K14  ", Versao = "I-GT 100", Combustivel = "Petrol", Ano = 2019, CilindradaouCapacidadeBateria = 999, Potencia = 100, TipoCaixa = "1 speed auto CVT", Nportas = "5", Foto = "nissan_micra_k14.jpg" },
                ...
                new Carros { Id = 24, Marca = "Peugeot", Modelo = "508 II SW", Versao = "BlueHDi 130 Auto", Combustivel = "Diesel", Ano = 2021, CilindradaouCapacidadeBateria = 1499, Potencia = 130, TipoCaixa = "8 speed Automatic", Nportas = "5", Foto = "peugeot_508_II_sw.jpg" },
                ...
                new Carros { Id = 26, Marca = "Renault", Modelo = "Clio 5", Versao = "Blue DCi 85", Combustivel = "Diesel", Ano = 2019, CilindradaouCapacidadeBateria = 1461, Potencia = 85, TipoCaixa = "6 speed Manual", Nportas = "5", Foto = "renault_clio_5.jpg" },
